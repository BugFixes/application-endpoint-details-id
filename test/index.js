...
const payLoadValid = {
  ...
  "pathParameters": {
    "id": process.env.TEST_APPLICATION_ID
  },
  "stageVariables": null,
  "requestContext": {
    "resourceId": "db8q1j",
    "resourcePath": "/details/id",
    "httpMethod": "GET",
...
describe('Application List Endpoint', () => {
  it('should list apps', (done) => {
    underTest(payLoadValid, console, (error, result) => {
      ...
      expect(resultObj).to.have.property('applicationId')
      expect(resultObj.applicationId).to.be.equal(process.env.TEST_APPLICATION_ID)
